...
def main() -> None:
    ...
    required = [
        "bva_training_completion.json", "bva_checkpoint_manifest.json", "fresh_seed_audit.json", "pre_eval_freeze.json",
    ...
    completion, freeze, statistics, mechanism = (load(name) for name in ("bva_training_completion.json", "pre_eval_freeze.json", "paired_ablation_statistics.json", "mechanism_interpretation.json"))
