#!/usr/bin/env python3
"""Run the frozen fresh seed-3 B0/BVA/B1/B2 PI2U ablation evaluation."""
...
LOGS = ROOT / ".local/logs/simulation/s4_3_pi2u/evaluation"
CACHE = ROOT / ".local/cache/simulation/s4_3_pi2u/evaluation/seed3"
TMP = ROOT / ".local/tmp/simulation/s4_3_pi2u/evaluation"
