...
Pretrained VLA-UniT checkpoints are released on Hugging Face: [xpeng-robotics/VLA-UniT-checkpoints](https://huggingface.co/xpeng-robotics/VLA-UniT-checkpoints).
...
> **The code release is in progress.** Data preparation, the UniT tokenizer,
> VLA-UniT (training + RoboCasa GR1 evaluation), and pretrained VLA-UniT
> checkpoints ([Hugging Face](https://huggingface.co/xpeng-robotics/VLA-UniT-checkpoints))
> are available now. WM-UniT and the real-world deployment stack will follow.
