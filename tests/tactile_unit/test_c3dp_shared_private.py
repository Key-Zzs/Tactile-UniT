...
def test_c4_and_c5_additions_are_bounded():
    ...
    c5 = sorted(path.name for path in (ROOT / "gr00t/tactile_unit").glob("*c5*"))
    assert c5 == [
        "c5_causal_visual.py", "c5_planned_action.py",
        "c5_runtime_router.py", "c5_uncertainty.py",
    ]
